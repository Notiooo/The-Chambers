...
void EmptyLinkFunctionForGeneratedCodePortalPlugin_init() {}
	...
	UPackage* Z_Construct_UPackage__Script_PortalPlugin()
	{
		...
		if (!ReturnPackage)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_UViewportResizedComponent_OnViewportResized__DelegateSignature,
			};
